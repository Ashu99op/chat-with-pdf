...
const Document = ({
  ...
  return (
    <div className='flex flex-col w-64 h-80 rounded-xl bg-white dark:bg-black drop-shadow-md justify-between p-4 transition-all transform hover:scale-105 hover:bg-indigo-600 dark:hover:bg-indigo-600 hover:text-white cursor-pointer group'>
          <div 
           className='flex-1'
           onClick={() => {
